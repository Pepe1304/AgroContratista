...
//     /* Guardar Parcelas */
//     public void guardarParcela(@SuppressWarnings("rawtypes") ParcelaModelo parcelaNueva) {
//         if (parcelaNueva == null) {
//             throw new IllegalArgumentException("La parcela proporcionada es nulo.");
//         }

//         String nombreString = parcelaNueva.getNombre();
...
//         return parcelasRepositorio.findById(UUID.fromString(idParcela))
//                 .orElseThrow(() -> new RuntimeException("Persona no encontrada"));

//     }

//     /* Modificar Parcelas */
//     public void modificarParcelaPorId(@SuppressWarnings("rawtypes") ParcelaModelo parcelaActualizada) {

//         // ParcelaModelo parcelaExistente =
//         // parcelasRepositorio.findById(parcelaActualizada.getId()).orElseThrow(() ->
