...
public class ParcelasCampo {
    ...
    public void modificarParcelaPorId(ParcelaModelo parcelaActualizada) {
        ...
        ParcelaModelo parcelaExistente = parcelasRepositorio.findById(parcelaActualizada.getId())
                .orElseThrow(() -> new RuntimeException("Establecimiento no encontrado"));
        parcelaExistente.setNombre(parcelaActualizada.getNombre());
        parcelaExistente.setCoordenadas(parcelaActualizada.getCoordenadas());
        parcelaExistente.setSuperficie(parcelaActualizada.getSuperficie());
        parcelaExistente.setLote(parcelaActualizada.getLote());
