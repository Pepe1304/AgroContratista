...
const Establecimientos = (onSearchChange, onAddClick) => {
  ...
  const [formData, setFormData] = useState({
    farmName: "",farmOwner: "",farmTown: "",farmProvince: "",
    plotLandName: "",plotLandCoordinates: "",plotLandArea: "",
    parcelName: "",parcelCoordinates: "",parcelArea: "",
  });
  ...
  const handleAddItem = () => {
    ...
    setFormData({...formData, plotLandName: "",plotLandCoordinates: "",plotLandArea: "",parcelName: "", parcelCoordinates: "",parcelArea: "", });
  };
  ...
  return (
    <>
      <div  style={{ border: "1px solid #D3D3D3", padding: "20px", marginTop: "20px", boxSizing: "border-box", backgroundColor: "#4CAF50", }}>
        ...
        <h6 style={{marginBottom: 0, fontSize: "18px",marginTop: "3px",display: "inline-block",fontWeight: 700,color: "#fff", }} > Establecimiento Agricola</h6>
      </div>
